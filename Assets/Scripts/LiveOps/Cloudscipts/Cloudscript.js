handlers.SetPlayerScore = function (args, context) {
    ...
    //check there is not already a higher score
    var validScore = true;
    var highestScore = args.score;
    for (var i = 0; i < playerStats.length; i++) {
        
        if (playerStats[i].StatisticName == args.statisticName) {

            if (playerStats[i].Value >= args.score) {
                highestScore = playerStats[i].Value;
                validScore = false;
            }
            break;
        }
    ...
    return {
        highestPlayerScore: highestScore
    };
}
